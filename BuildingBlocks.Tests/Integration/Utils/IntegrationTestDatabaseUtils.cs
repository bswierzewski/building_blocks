...
public static class IntegrationTestDatabaseUtils
{
    ...
    /// <summary>
    /// Applies pending EF Core migrations for the specified DbContext using a schema-specific migrations history table.
    /// </summary>
        ...
        where TContext : DbContext
    {
        ...
        var options = new DbContextOptionsBuilder<TContext>()
            .UseNpgsql(connectionString, npgsql =>
                npgsql.MigrationsHistoryTable(MigrationsHistoryTableName, normalizedSchema))
            .Options;
