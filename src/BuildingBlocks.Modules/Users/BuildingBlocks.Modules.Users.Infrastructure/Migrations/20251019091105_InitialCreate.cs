        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModifiedBy = table.Column<Guid>(type: "uuid", maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExternalIdentities_Provider",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExternalIdentity_Provider_ExternalUserId",
                table: "ExternalIdentities",
                columns: new[] { "Provider", "ExternalUserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Permission_ModuleName",
                table: "Permissions",
                column: "ModuleName");
